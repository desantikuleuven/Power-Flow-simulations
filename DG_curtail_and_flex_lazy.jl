...
#=
  ...
  Compute PF by using: 
  -   build_pf_dg_curtail --> compute PF by exploiting both DR and DG curtailment
...
model = "build_pf_dg_curtail"  #needed for voltage profile plotting
# Solve PF 
...
#bus, gen, branch
plot = plot_grid(net_data, "p_flex","curtailment", "loading"; display_flow = true)
